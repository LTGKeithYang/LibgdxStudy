...
//    private Skin skin;
    ...
    public void show() {
        stage = new Stage();
        textureAtlas = new TextureAtlas(Gdx.files.internal("assets30/mainmenu.pack"));
//        skin = new Skin(Gdx.files.internal("assets30/mainmenu.json"), textureAtlas);
        startButton = new Button(Assets.menuSkin, "startbutton");
        optionsButton = new Button(Assets.menuSkin, "optionsbutton");
        creditsButton = new Button(Assets.menuSkin, "creditsbutton");
        facebookButton = new Button(Assets.menuSkin, "facebookbutton");
